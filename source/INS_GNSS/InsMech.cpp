...
CombineNav::NavState CombineNav::InsMech(const CombineNav::NavState& laststate, const INS::IMUDataEpoch& lastimu, const INS::IMUDataEpoch& thisimu)
{
	...
	Eigen::MatrixXd qbn_k_1 = laststate.qbn;
	...
	Eigen::Vector4d qbb = Eigen::Vector4d::Zero();
	Eigen::Vector4d qnn = Eigen::Vector4d::Zero();
	Eigen::Vector4d qbn_k = Eigen::Vector4d::Zero();
	Eigen::Matrix3d Cbn_tk = Eigen::Matrix3d::Zero();
	...
	Eigen::Matrix3d Cb_n_tk_1 = quaternion2C_b_n(qbn_k_1);
