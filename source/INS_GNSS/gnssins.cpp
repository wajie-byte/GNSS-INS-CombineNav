...
void CombineNav::gnssins(CombineNav::Config config)
{
	//
	...
	//if back_filter
	std::vector<FilterEpoch> history;
	...
	//进行反向滤波
	//CombineNav::gnssins_backwardfilter(navstate, kf, imudata_proc,gnssdata_proc,config,param,navstate_history_back);
